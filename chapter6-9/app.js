...
var totalObtainedMarks = obtainedMarkSubject1 + obtainedMarkSubject2 + obtainedMarkSubject3;
...
// document.write("<h1>Subject Obtained Marks</h1><br/>");
// document.write(`${subjec1} ${obtainedMarkSubject1}`);

// document.write(`${subjec2} <br/>`);
// document.write(`${subjec3} <br/>`);
